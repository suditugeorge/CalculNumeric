function [raspuns] = problema9Fct2(epi)
...
%aproximarea solutiei folosind metoda Pozitiei False a primei functii
%raspuns = raspuns;

%numarul de iteratii necesare
raspuns = nr1;

end

function [functie1] = f1(x)
functie1 = cos(exp(x)-2);
end
